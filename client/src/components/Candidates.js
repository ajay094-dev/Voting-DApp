...
import candidateiconAAP from "../images/PartyLeaders/AAPPL.jpg";
import candidateiconAITC from "../images/PartyLeaders/AITCPL.jpg";
import candidateiconBJP from "../images/PartyLeaders/BJPPL.jpg";
import candidateiconBSP from "../images/PartyLeaders/BSPPL.jpg";
import candidateiconCPI from "../images/PartyLeaders/CPIPL.jpg";
import candidateiconINC  from "../images/PartyLeaders/INCPL.jpg";
  ...
  render() {
    ...
    if (this.state.candidateList) {
      candidateList = this.state.candidateList.map((candidate) => {
        // Determine candidate image based on party
        let candidateImage =
          candidate.party === "AAP"
            ? candidateiconAAP
            : candidate.party === "AITC"
            ? candidateiconAITC
            : candidate.party === "BJP"
            ? candidateiconBJP
            : candidate.party === "BSP"
            ...
            : candidate.imghash === ""
            ? candidateicon
            : `https://ipfs.infura.io/ipfs/${candidate.imghash}`;
